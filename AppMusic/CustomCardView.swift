...
class CustomCardView: UIView {
    ...
    private func setUpConstraints(){
        ...
        NSLayoutConstraint.activate([self.profileBorderView.topAnchor.constraint(equalTo: cardContainerView.topAnchor, constant: 60),
                                     ...
                                     self.likeAndTimeLabel.topAnchor.constraint(equalTo: self.likeAndTimeLabel.bottomAnchor, constant: 10),
